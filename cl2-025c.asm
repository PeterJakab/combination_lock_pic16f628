...
; 025t-20091225 toggle operation
;
;**********************************************************************
	list	p=16f628
...
pulsewidth	EQU D'25' ; delay in 20ms steps
